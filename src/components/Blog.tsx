  ...
  return (
    <section id="blog" aria-labelledby="blog-heading" className="scroll-mt-20 border-t border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02]">
      <div className="mx-auto max-w-5xl px-6 py-24">
        <p className="mb-2 text-xs tracking-widest text-black/60 dark:text-white/50 uppercase">Blog</p>
        ...
        <div className="space-y-4">
          {articles.map((article) => (
            ...
            >
              <span>
                <span className="mb-1 block text-xs tracking-widest text-black/60 dark:text-white/50 uppercase">
                  {article.source}
                </span>
